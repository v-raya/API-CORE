...
/**
 * Implementation of JWT processing realm. This realm validates JWT token and
 * extract identity claim from JWT payload. Identity claim example:
 * {"user" : "username",
 * "roles" : ["role1", "role2"]
 * }
 * <p>
 * During authentication process this realm puts user name as primary credential
 * and mapped identity claim as secondary. So authorization process will expect 2 principals.
 */
public class JwtRealm extends AuthorizingRealm {
    ...
    private String validate(String token) throws ApiAuthenticationException {
        return (String) Jwts.parser().setSigningKey(validationKey).
    ...
    /**
     * Maps JWT payload to user info. For more complex user info override this method.
     * User info will be accessible as secondary principal:
     * <p>
