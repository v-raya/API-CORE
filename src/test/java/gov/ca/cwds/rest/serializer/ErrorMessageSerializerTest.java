...
//        assertEquals("expected json to contain both error messages",expectedJson, jsonWriter.toString());
//    }
//
//    @Test
...
//        assertEquals("expected json to contain a single error messages",expectedJson, jsonWriter.toString());
//    }
//
//    @Test
...
//        assertEquals("expected json to contain an empty error messages",expectedJson, jsonWriter.toString());
//    }
//
//    @Test
