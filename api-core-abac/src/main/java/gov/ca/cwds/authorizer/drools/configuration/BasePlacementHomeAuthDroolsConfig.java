...
/**
 * Base Drools config class for PlacementHome authorization.
 * 
 * @author CWDS TPT-2 Team
 */
public abstract class BasePlacementHomeAuthDroolsConfig extends
    DroolsConfiguration<PlacementHome> implements DroolsAuthorizer {
