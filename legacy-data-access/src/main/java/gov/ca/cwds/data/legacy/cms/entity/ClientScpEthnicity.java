...
public class ClientScpEthnicity implements PersistentObject {
    public static final String NQ_FIND_BY_TYPE_AND_ESTABLISHED_FOR_ID =
            "gov.ca.cwds.data.legacy.cms.entity.ClientScpEthnicity.findByTypeAndEstId";
    public static final String NQ_PARAM_ESTABLISHED_FOR_CODE = "establishedCode";
    public static final String NQ_PARAM_ESTABLISHED_FOR_ID = "establishedId";
    public static final String ESTABLISHED_FOR_CLIENT_CODE = "C";
    public static final String ESTABLISHED_FOR_SUBSTITUTE_CARE_PROVIDER_CODE = "S";
