 ...
 *
 *         A person providing daily care and supervision at a PLACEMENT_HOME, or the license holder
 *         for a PLACEMENT_HOME. This person may be a prospective SUBSTITUTE_CARE_PROVIDER,
 *         certified, licensed for 24-hour care of children, or exempt from licensing. Any address
 *         for the SUBSTITUTE_CARE_PROVIDER other than that of the PLACEMENT_HOME should be
 *         documented in this entity type. Identified caretaker(s) of the prospective adoptive child
 *         should also be documented in this entity type. This individual could be a related or
 *         unrelated person.
 */
@Entity
@Table(name = "SB_PVDRT")
...
public class SubstituteCareProvider implements PersistentObject {
  ...
  /**
   * ZIP_NUMBER - The first five digits of the zip code for the SUBSTITUTE CARE PROVIDER's address.
   */
  @Basic
   ...
   * therefore owned by LIS. The values permitted are Y or N.
   */
  @Basic
