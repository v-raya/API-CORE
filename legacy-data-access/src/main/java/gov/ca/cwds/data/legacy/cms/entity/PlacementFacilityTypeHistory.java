 ...
 * Placement Home Facility type was of a specific type. Subject Area -- PLACEMENT_HOME_INFORMATION
...
public class PlacementFacilityTypeHistory implements PersistentObject {
  ...
  /**
   * FKPLC_HM_T - Mandatory Foreign key that RECORDS_PLCMNT_FAC_TYPE_HSTRY_INFO_FOR a
   * PLACEMENT_HOME.
   */
  @Id
  ...
  /**
   * CREATION_TIMESTAMP - The time and date when the PLACEMENT_FACILITY_TYPE_HISTORY was first
   * created.
   */
  ...
  /**
   * END_TIMESTAMP - The time and date of the most recent update to an occurrence of this entity
   * type.
   */
  @Column(name = "END_TS")
   ...
   * facility which can be used for PLACEMENT_FACILITY_TYPE_HISTORY (e.g., Foster Family Agency,
   * Licensed Foster Family Home, Relative Home, Small Family Home, Group Home, etc.).
   */
  @Column(name = "PLC_FCLC", nullable = false)
  private Short placementFacilityType;

  /**
   * START_TIMESTAMP - The time and date of the most recent update to an occurrence of this entity
   * type.
   */
