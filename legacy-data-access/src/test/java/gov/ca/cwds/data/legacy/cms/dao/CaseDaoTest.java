  ...
  public void testFind() throws Exception {
    ...
    executeInTransaction(
        ...
        (sessionFactory) -> {
          ...
          assertEquals(
              "Child Runaway", c.getCaseClosureReasonType().getShortDescription()); // CLS_RSNC
          assertFalse(c.getCaseplanChildrenDetailIndVar()); // CSPL_DET_B
          assertEquals(
              "Very Long text", c.getClosureStatementText().getTextDescription()); // CL_STM_TXT
          ...
          assertEquals(
              ResponsibleAgency.COUNTY_WELFARE_DEPARTMENT, c.getResponsibleAgency()); // RSP_AGY_CD
