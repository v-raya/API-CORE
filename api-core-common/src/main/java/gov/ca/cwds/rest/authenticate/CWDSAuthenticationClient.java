 ...
 *
 */
public class CWDSAuthenticationClient extends CWDSLoginType {
  ...
  private static String getAccessCode(String location) {
  ...
  private static String getRedirectUrlParam(String location) {
    return location.substring(location.indexOf('=') + 1, location.length());
  }

  private static String getDeviceLogicId(String response) {
  ...
  private static String getRequestVerificationToken(String response) {
